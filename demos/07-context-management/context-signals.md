...
| **Stale instructions** | Repo instructions contradict your current task or are too broad | Edit `copilot-instructions.md` | Override locally in the prompt for this task only | Prevents the model from over-applying a rule that doesn't fit; saves correction turns |
